...
#ifndef ALGORITHM_WEIGHTED_DIGRAPH_TEST_H
#define ALGORITHM_WEIGHTED_DIGRAPH_TEST_H
...
namespace data_structures {
    ...
    void testWeightDigraph() {
        WeightedDigraph<std::string, int32_t> graph;
...
#endif //ALGORITHM_WEIGHTED_DIGRAPH_TEST_H
